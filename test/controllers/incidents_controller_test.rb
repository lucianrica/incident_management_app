...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { content: @incident.content, priority: @incident.priority, resolution: @incident.resolution, solved: @incident.solved, title: @incident.title } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { content: @incident.content, priority: @incident.priority, resolution: @incident.resolution, solved: @incident.solved, title: @incident.title } }
